...
from app.api.v1 import scan, cards, lms, voice, analytics, auth, portfolio, colearn
...
app.include_router(colearn.router, prefix="/api/v1", tags=["AI Co-Learning & Parametric Habrutha"])
