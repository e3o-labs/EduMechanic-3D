...
Supports Planetary Sharpener and Music Box assemblies.
"""
import zipfile
import io
import json
...
class SlicerPackageExporter:
    ...
    def generate_3mf_package(
        ...
        if card_id == "musicbox":
            ...
            gear_bytes = stl_builder.create_involute_gear_stl(module=module, teeth_count=28, face_width=6.0 * scale_ratio, shaft_dia=4.0 * scale_ratio, tolerance=self.tolerance)

            manifest = {
                "card_id": card_id,
                "pipeline": "EduMechanic-3D Music Box Snap-to-Print Engine v3.1",
                ...
                "recommended_slicer_settings": {
                    "layer_height_mm": 0.12 if micro_print else 0.16,
...
<model unit="millimeter" xml:lang="en-US" xmlns="http://schemas.microsoft.com/3dmanufacturing/core/2015/02">
  ...
  <build>
    ...
    <item objectid="3" transform="1 0 0 0 1 0 0 0 1 50 0 0"/>
            ...
            # Default / Sharpener Planetary Pack
            ...
            manifest = {
                "card_id": card_id,
                "pipeline": "EduMechanic-3D Planetary Helical Snap-to-Print Engine v3.1",
